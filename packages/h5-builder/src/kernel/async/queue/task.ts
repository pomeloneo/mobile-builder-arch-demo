import { Disposable, type IDisposable } from '@/kernel/dispose';
import { type Event, Emitter } from '@/kernel/event';
import { makeErrorBy, type ILvErrorRef } from '@/kernel/error';
